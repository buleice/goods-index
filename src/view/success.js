...
import {GET_SUCCESS_BUY} from '../api/requestApis';
import './success.scss'
            ...
            return (
                <div className={`App ${this.props.modalOpen ? 'modal-open' : ''}`}>
                    <div className="slider-banner">
                        {this.state.buyingInfo.Fbanner.length > 1 ? (
                            <Carousel slideItemData={this.state.goodInfo.buyingInfo.Fbanner}></Carousel>) : (
                            <div className='single-banner'><img src={this.state.buyingInfo.Fbanner[0]} alt={"图片"}/>
                       </div>)}
                    ...
                    <div className="avatar">
                        <ul className="avatar-top">
                                <li>
                                    ...
                                    <span className="avater-nick">{this.state.nick}</span>
                                </li>
                        </ul>
                    </div>
                    {
                    this.state.buyingInfo['Furl']!=''?(
                        <div className="footer">
                               <a className="shangke" href={`${this.state.buyingInfo.url}`}>去上课</a>
                        </div>
                    ) :null
                }{
                    this.state.buyingInfo['Furl']==''?(
                        <div className="footer">
                            <a className="shangke" href={`/course/index?id=${this.state.buyingInfo._id.$oid}`}>去上课</a>
                        </div>
                    ):null
                }
