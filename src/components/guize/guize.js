...
export default class GuiZe extends Component {
    ...
    render() {
        return (
            <div>
                <div className={this.props.showStatus?'show-cover-mask':'hide-cover-mask'} onClick={()=>this.props.onGuizeClick(false)}></div>
                ...
                <div className={this.props.showStatus?"show-jieshao":"hide-jieshao"}>
                    <div className="header">
                        <span className="title">活动规则</span>
                        <img onClick={()=>this.props.onGuizeClick(false)} src="//wxyx.youban.com/img/delete.png" id="close-button-t"/>
                    </div>
